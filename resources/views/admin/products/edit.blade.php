...
@section('title', 'ویرایش محصول | نکسا شاپ')
...
@section('content')
    ...
    <div class="mb-6 flex items-center gap-3">
        ...
        <h1 class="text-lg font-bold text-neutral-900">ویرایش {{ $product->name }}</h1>
    </div>

    <form method="POST" action="{{ route('admin.products.update', $product) }}" class="rounded-2xl border border-neutral-200 bg-white p-6 shadow-sm">
        @csrf
        @method('PUT')
